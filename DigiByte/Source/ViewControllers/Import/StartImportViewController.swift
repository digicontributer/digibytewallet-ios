...
private let mainURL = "https://digiexplorer.info/api/addrs/utxo"
private let fallbackURL = "https://digiexplorer.info/api/addrs/utxo"
...
class StartImportViewController : UIViewController {
    ...
    private let bullet = UIImageView(image: UIImage(named: "deletecircle"))
    ...
    private func addConstraints() {
        ...
        illustration.constrain([
            ...
            illustration.constraint(.centerY, toView: header, constant: E.isIPhoneXOrGreater ? C.padding[3] : C.padding[1]) ])
