...
class SearchHeaderView : UIView {
    ...
    private func addConstraints() {
        ...
        let titleSize = NSString(string: cancel.titleLabel!.text!).size(withAttributes: [NSAttributedString.Key.font : cancel.titleLabel!.font as Any])
        cancel.constrain([
        ...
        searchBar.constrain([
            ...
            searchBar.topAnchor.constraint(equalTo: topAnchor, constant: E.isIPhoneXOrGreater ? C.padding[5] : C.padding[2]),
