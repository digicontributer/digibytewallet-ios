...
class StartWipeWalletViewController : UIViewController {
    ...
    private func addConstraints() {
        ...
        illustration.constrain([
            ...
            illustration.constraint(.centerY, toView: header, constant: E.isIPhoneXOrGreater ? C.padding[5] : C.padding[3]) ])
        message.constrain([
    ...
    private func setInitialData() {
        ...
        bullet.tintColor = UIColor(red: 0xFF / 255, green: 0x74 / 255, blue: 0x16 / 255, alpha: 1.0)
